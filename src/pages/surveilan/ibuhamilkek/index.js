    ...
    const toggleDatePicker = () => {
      ...
      const handleDateChange = date => {
        ...
        if (date <= currentDate) {
          ...
          setForm({ ...form, waktupendaftaran: date });
          setSelectedDateText(
...
const handleSaveDate = () => {
  ...
  const PickerDate = () => {
    ...
    const initialDate = form.waktupendaftaran || new Date();
    ...
    const HandleSimpan = () => {
        if ((form.namaibu.length == 0) | (form.nik.length == 0) | (form.usiaibu.length == 0) | (form.alamat.length == 0) | (form.usiakehamilan.length == 0) | (form.hasilpengukuran.length == 0)) {
    ...
    <View style={{flex:1,  backgroundColor:'white'}}>
        ...
        <Text style={{ left: -10, fontFamily: 'Poppins-Regular', fontSize: 12, color: 'black' }}>
          Berapa Minggu
                ...
                {/*HASIL PENGUKURAN*/}
                <Text style={{fontFamily:'Poppins-SemiBold', left:2, marginTop:20}}>Hasil Pengukuran</Text>
                <View style={{ flexDirection: 'row', alignItems: 'center', borderColor: 'gray', borderWidth: 1, borderRadius: 5, backgroundColor:'#f5f5f5'}}>
                <TextInput
                style={{
                flex: 1,
          ...
          placeholderTextColor="gray"
          keyboardType="numeric"
          value={form.hasilpengukuran}
        onChangeText={value => setForm({...form,hasilpengukuran: value})}
        />
        <Text style={{ left: -10, fontFamily: 'Poppins-Regular', fontSize: 12, color: 'black' }}>
          Berapa cm
        </Text>
